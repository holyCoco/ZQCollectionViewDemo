       ...
       andCollectionCellClass:(Class)cellClass
{
    ...
    if (self) {
        ...
        UICollectionView* collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height) collectionViewLayout:viewLayout];
...
- (void)setIsShowScrollIndicator:(BOOL)isShowScrollIndicator
{
    _isShowScrollIndicator = isShowScrollIndicator;
    self.collectionV.showsHorizontalScrollIndicator = isShowScrollIndicator;
    self.collectionV.showsVerticalScrollIndicator = isShowScrollIndicator;
}
